...
train_data = ImageTxtDataset(r"D:\shixi\HuaqingyuanjianTraining\2022\Day3\dataset\train.txt",
                             r"D:\shixi\HuaqingyuanjianTraining\2022\Day3\image2\train",
...
# 添加tensorboard
writer = SummaryWriter(r"D:\shixi\HuaqingyuanjianTraining\2022\Day2\conv_logs")
...
for i in range(epoch):
    ...
    # 保存每一轮训练模型
    torch.save(chen,f"D:/shixi/models/chen_{i}.pth")
    print("模型已保存")
